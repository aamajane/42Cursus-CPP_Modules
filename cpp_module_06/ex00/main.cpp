...
/*   Updated: 2023/01/12 15:13:14 by aamajane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	convert(int type, std::string s)
{
	...
	if (type > CHAR && (n < std::numeric_limits<char>::min() || n > std::numeric_limits<char>::max()))
	...
	if (type > INT && (n < std::numeric_limits<int>::min() || n > std::numeric_limits<int>::max()))
		std::cout << "int    : impossible" << std::endl;
	else
		std::cout << "int    : " << static_cast<int>(n) << std::endl;

	if (type > FLOAT && (n < std::numeric_limits<float>::min() || n > std::numeric_limits<float>::max()))
