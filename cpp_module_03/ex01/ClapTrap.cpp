...
/*   Updated: 2022/12/25 15:42:09 by aamajane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
	: _name("Default"), _healthPoints(100), _energyPoints(50), _attackDamage(20)
{
	std::cout << "ClapTrap default constructor called" << std::endl;
}

ClapTrap::ClapTrap(std::string const name)
	: _name(name), _healthPoints(100), _energyPoints(50), _attackDamage(20)
{
